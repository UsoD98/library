...
public class BookDao {
    ...
    public List<RentalBookVo> selectRentalBookHistory(int u_m_no) {
        log.info("[BookDao] selectRentalBookHistory HAS BEEN CALLED");
        ...
        List<RentalBookVo> rentalBookVos = new ArrayList<>();
    ...
    public List<HopeBookVo> selectRequestHopeBooks(int u_m_no) {
        log.info("[BookDao] selectRequestHopeBooks HAS BEEN CALLED");
